    ...
    if (isset($_GET['add'])){
        ...
        <div class="container">
            <form class="w-100" method="POST" name="addSlider" action="<?php $_SERVER['PHP_SELF']; ?>" enctype="multipart/form-data">
                ...
                <div class="custom-file ml-3 my-4">
                    <div class="col-sm-9">
            ...
            <div class="container">
                <?php
                    ...
                    foreach ($slides as $slide){
                        ?>
                        <form class="w-100 border rounded border-dark position-relative" method="POST" action="<?php $_SERVER['PHP_SELF']; ?>" enctype="multipart/form-data">
                            ...
                            <a href="index.php?go=website&delete&id=<?php echo $slide['ID']; ?>" class="btn btn-danger position-absolute confirm" style="top:5px;left: 5px">Delete</a>
                        </form>
                        <?php
                        if ($_SERVER['REQUEST_METHOD'] === 'POST'){
